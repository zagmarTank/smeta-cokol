...
var cssCalc = (value, opt = {}) => {
	...
	const cachedResult = getCache(cacheKey);
	if (cachedResult !== false) return cachedResult.item;
	let resolvedValue = calc(parseCalcTokens(tokenize({ css: value }), opt).join(""), { toCanonicalUnits: true });
...
//#endregion
export { Calculator, cssCalc, cssVar, parseCalcTokens, parseVarTokens, resolveCustomProperty, resolveDimension, resolveVar, serializeCalc, sortCalcValues };
